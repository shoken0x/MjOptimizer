    ...
    override func spec() {
        ...
        describe("MentsuFactory.createMentsu"){
            ...
            it("return nil if invalid mentsu"){
                ...
                expect(MentsuFactory.createMentsu(pl) == nil).to(beTruthy())
            }
        }
        describe("MentsuFactory.isChi"){
            it("workds"){
                expect(MentsuFactory.isChi(Pai.parseList("m1tm2tm3l")!)).to(beTruthy())
                expect(MentsuFactory.isChi(Pai.parseList("m1lm2tm3t")!)).to(beTruthy())
                expect(MentsuFactory.isChi(Pai.parseList("m2tm1lm3t")!)).to(beTruthy())
                expect(MentsuFactory.isChi(Pai.parseList("m4lm2tm3t")!)).to(beTruthy())
                
                expect(MentsuFactory.isChi(Pai.parseList("m1lm2lm3t")!)).to(beFalsy())
                expect(MentsuFactory.isChi(Pai.parseList("m1lm2lm3l")!)).to(beFalsy())
                expect(MentsuFactory.isChi(Pai.parseList("m1ts2tm3l")!)).to(beFalsy())
                expect(MentsuFactory.isChi(Pai.parseList("j1tj2tj3l")!)).to(beFalsy())
                expect(MentsuFactory.isChi(Pai.parseList("r1tr2tr3l")!)).to(beFalsy())
                expect(MentsuFactory.isChi(Pai.parseList("s1ts2tm3l")!)).to(beFalsy())
            }
        }
    }
}
