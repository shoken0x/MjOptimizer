    ...
    override func spec() {
        describe("resolve"){
            ...
            it("works2"){
                ...
                expect(agariList[0].mentsuList.get(0).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[0].mentsuList.get(1).toString()).to.equal("アンコウ:m1")
                expect(agariList[0].mentsuList.get(2).toString()).to.equal("シュンツ:m4m5m6")
                expect(agariList[0].mentsuList.get(3).toString()).to.equal("シュンツ:m7m8m9")
                expect(agariList[0].mentsuList.get(4).toString()).to.equal("トイツ:m9")
            }
            it("works3"){
                ...
                expect(agariList[0].mentsuList.get(0).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[0].mentsuList.get(1).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[0].mentsuList.get(2).toString()).to.equal("シュンツ:m2m3m4")
                expect(agariList[0].mentsuList.get(3).toString()).to.equal("シュンツ:m2m3m4")
                expect(agariList[0].mentsuList.get(4).toString()).to.equal("トイツ:m1")
                expect(agariList[1].atama.toString()).to.equal("トイツ:m4")
                expect(agariList[1].mentsuList.get(0).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[1].mentsuList.get(1).toString()).to.equal("アンコウ:m1")
                expect(agariList[1].mentsuList.get(2).toString()).to.equal("アンコウ:m2")
                expect(agariList[1].mentsuList.get(3).toString()).to.equal("アンコウ:m3")
                expect(agariList[1].mentsuList.get(4).toString()).to.equal("トイツ:m4")
                expect(agariList[2].atama.toString()).to.equal("トイツ:m4")
                expect(agariList[2].mentsuList.get(0).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[2].mentsuList.get(1).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[2].mentsuList.get(2).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[2].mentsuList.get(3).toString()).to.equal("シュンツ:m1m2m3")
                expect(agariList[2].mentsuList.get(4).toString()).to.equal("トイツ:m4")
            }
        }
